...
class FastScroller(
    ...
    private fun convertDpToPx(dp: Int) =
        (dp.toFloat() * rv.resources.displayMetrics.density).roundToInt()
    ...
    override fun onTouchEvent(rv: RecyclerView, me: MotionEvent) {
        ...
        when (me.action) {
            MotionEvent.ACTION_DOWN, MotionEvent.ACTION_UP, MotionEvent.ACTION_CANCEL -> onInterceptTouchEvent(
                rv,
                me
            )
