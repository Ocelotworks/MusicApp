...
class UtilTest {
    ...
    private fun getSong(): Media {
        return Util.jsonToSong(JSONObject("{\"song_id\":\"c1190133-1e6b-468f-8c3c-ce1bef49adc6\",\"artist_id\":\"db7411ae-14c3-4029-aa25-ef306db6d47b\",\"name\":\"test\",\"title\":\"test\",\"album\":\"43c788b3-7342-4c38-ab17-66846cfa4255\",\"path\":\"test\"}"))
    }
